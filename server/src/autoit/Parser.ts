...
export default class Parser {
    ...
    public static isSyntaxError(e: unknown): e is SyntaxError {
        return e instanceof Error && 'location' in e && 'expected' in e && 'found' in e && 'format' in e;
    }

    public static isPositionWithinLocation(
        line: number,
        column: number,
    ...
    public static AstToString(
        ...
        switch (type) {
            ...
            case 'AssignmentExpression':
                return this.AstToString(ast.left) +
                    ast.operator +
                    this.AstToString(ast.right);
    ...
    public static AstArrayToStringArray(
        astArray:

...
//MultiLineComment = MultiLineCommentStartTag (LiteralWhitespace (!Newline .)*)? (!(Newline Whitespace* MultiLineCommentEndTag) Newline Whitespace* (!Newline .)*)* Newline Whitespace* MultiLineCommentEndTag /*(LiteralWhitespace (!Newline .)*)?*/

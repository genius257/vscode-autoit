...
- Visual feedback during startup indexing: a status bar item showing the number of files being loaded and a native progress indicator
...
- Include files that cannot be decoded are reported to the user via an error message, while resolution continues with the remaining include locations
...
- File changes are now detected: created, changed and deleted files in workspace folders, the AutoIt3 installation include directory, and user defined library directories are now picked up or cleaned up via file watching (issue #76)
...
[Unreleased]: https://github.com/genius257/vscode-autoit/compare/1.9.0...HEAD
[1.9.0]: https://github.com/genius257/vscode-autoit/compare/1.8.11...1.9.0
